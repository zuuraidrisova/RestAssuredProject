...
public class hr_ords_locationsPojoTest {
    ...
    @DisplayName("testing the /locations endpoint and saving the response as list")
    @Test
    public void testLocationJsonArrayToPojoList(){
        ...
        //we assert that we have 23 items in the list, using hamcrest library, so we
        // have to do static import
       // import static org.hamcrest.MatcherAssert.*;
        //import static org.hamcrest.Matchers.hasSize;
